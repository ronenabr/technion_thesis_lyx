...
אם צריך לשים קישור בתקציר העברי, )למשל לצורך ציטוט מקור, כאשר משתמשים גם ב-\L{\texttt{hyperref}} שיוצר קישורים בתוך ה-PDF עבור ציטוטי מקורות(, אפשר לעטוף אותו בתוך \textenglish{{\textbackslash}L\{\}} , כך: \textenglish{\cite{Hoeffding}}.
...
שימו לב כי העמודים בעברית אמורים להיות מיוצרים בסדר ה''הפוך'', הווה אומר העמוד האחרון בקובץ ה-\textenglish{PDF} הוא הכריכה העברית, לפניו השער העברי, ודפי התקציר צריכים להופיע בסדר הפוך )וכן במספור רומי, לפי נהלי הטכניון(. כך עמוד זה, העמוד הראשון בתקציר יש לצפות, ממוספר ב-i ונמצא אחרון בקובץ ה-\textenglish{PDF}...

\newpage 

... ואילו עמוד זה של התקציר המורחב בעברית, שהינו העמוד השני בתקציר, ממוספר ב-ii ונמצא ראשון בקובץ ה-\textenglish{PDF} --- לפני עמוד i. המטרה היא, שבעת ההדפסה לא יהיה צורך להפוך דפים, לשנות את סדרם וכולי - רק להדפיס ולכרוך.
